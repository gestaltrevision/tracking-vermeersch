...
from acc_ut import process_readings_participant,get_events,get_events_index,create_event_col,segment_signal
...
if __name__ == "__main__":
    # Sample usage :
    #python process_raw_acc.py --main_dir "C:\Users\jeuux\Desktop\Carrera\MoAI\TFM" --data_type Acc_Gyros --base_name Final_data --dataset_name IMU_dataset
    #
    ...
    for participant_folder in tqdm(participant_folders):
        ...
        sensor_comp,labels=segment_signal(df,new_samples_number,window_size=250)
